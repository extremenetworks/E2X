...
from EOS_read import EosSetSshCommand
from Switch import Switch

from unittest.mock import Mock


class EosSetSshCommand_test(unittest.TestCase):

    def setUp(self):
        self.switch = Mock(spec=Switch)
        self.cmd = EosSetSshCommand(self.switch)
    ...
    def test_do_disabled_ok(self):
        ...
        self.switch.set_ssh_inbound.assert_called_once_with(False,
                                                            'config')
    ...
    def test_do_enabled_ok(self):
        ...
        self.switch.set_ssh_inbound.assert_called_once_with(True,
                                                            'config')
        self.assertEqual('', result)
